...
<button  onClick="window.location.href='mailto:youremail@email.here?subject=Bug report';" id="report" title="Report" style="display: block;"> Report an issue </button>
...
<center><info>
<i>
<p>Abusing the report system will get you in serious consequences</p>
</i>
</info></center>
...
file_put_contents($bidder, implode($lines));

          $filefdata = fopen($bidder, "r") or die("Unable to open file!");
$i =0;
while(! feof($filefdata))
  {
        $place = fgets($filefdata);
...
<br>Reason <br><input type="text" name="reason" placeholder="Reason"><br>

<br>your email <br><input type="text" name="yoemail" placeholder="your email"><br>
