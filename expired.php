...
#grad {
	...
	height: 90vh;
	color: #fff;
	background: linear-gradient(45deg,  #3a6186, #89253e, #203a43, #2c5364);
...
var x = setInterval(function() {
  ...
  var seconds = Math.floor((distance % (1000 * 60)) / 1000);
      ...
      document.getElementById("timer").innerHTML = "You have "+ days + " day(s) " + hours + " hour(s) "
  + minutes + " minute(s) " + seconds + " second(s) " +" to bid left.";
...
for ($x = 0; $x <= $countf; $x++) {
    $filefdata = fopen("information/"."end".$x."f".".txt", "r") or die("Unable to open file!");
while(! feof($filefdata))
  {
...
for ($x = 0; $x <= $count; $x++) {
$filemdata = fopen("information/"."end".$x."m".".txt", "r") or die("Unable to open file!");
